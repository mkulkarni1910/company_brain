...
_SYSTEM = (
    ...
    "keep it generic. Do NOT answer, do NOT promise an outcome, do NOT copy these examples "
    ...
    "  • '(asked by Tom) can we help Priya with this refund' → 'On it, Tom — looking into Priya's refund…'\n"
    "  • 'can we help Priya with this refund' → 'On it — looking into Priya's refund…'\n"
