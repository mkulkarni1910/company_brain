...
// GitHub octocat SVG path (16px) — matches the mockup's pr-icon
const OctocatPath =
      ...
      <div className="pr-card">
        <div className="pr-head">
          <span className="pr-icon">
            <svg viewBox="0 0 24 24" fill="currentColor"><path d={OctocatPath} /></svg>
          </span>
          <span className="pr-title">Connect GitHub</span>
        </div>
        <div className="pr-summary">
          The PR will be authored as you — connect your GitHub once, then ask again.
        </div>
        <div className="pr-actions">
          <a className="pr-create" href={action.connect_url} target="_blank" rel="noreferrer">
            Connect GitHub &#8599;
          </a>
        </div>
        <div className="pr-foot">
          🔒 Nothing reaches GitHub until you connect — the PR will be authored as you.
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="pr-card">
      <div className="pr-head">
        ...
        <span className={`pr-chip${state === "created" ? " done" : ""}`}>
          {state === "created"
            ? "PR created"
            : state === "cancelled"
            ? "cancelled"
      ...
      <div className="pr-foot">
        {state === "created"
          ? "🔒 Authored as you · awaiting review from a code owner."
          : "🔒 Nothing reaches GitHub until you confirm — the PR will be authored as you."}
      </div>
    </div>
  );
}
